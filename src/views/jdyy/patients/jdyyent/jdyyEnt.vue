      ...
      el-form(:model="formModel" :rules="rules" ref="formModel" label-width="80px")
        ...
        div.block-boxs
          el-table(:data="gridData" border="1px solid #3465cb" style="width: 100%;" cell-style=" color: #3465cb")
            ...
            el-table-column(prop="diagnosis" label="诊断" width="200" align="center"  )
            el-table-column(prop="name" label="术式" width="200" align="center")
          ...
          .right-ul
            ...
            .right-li
              ...
              button
                ...
                font-size: 16px
                outline:none
            .right-li:first-child button
              color: #3465cb
            .right-li:last-child button
              color: red
    .box
      width 28%
      float right
