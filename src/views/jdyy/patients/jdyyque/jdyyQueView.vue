  ...
  kalix-dialog.user-add(title='查询详情页' bizKey="jdyyQue" ref="kalixBizDialog" v-bind:formModel.sync="formModel" isView)
    div.el-form(slot="dialogFormSlot")
      ...
      el-form-item(label="入院日期" prop="dateAdmission" v-bind:label-width="labelWidth")
        el-date-picker(v-model="formModel.dateAdmission" type="date" placeholder="选择日期" value-format="yyyy-MM-dd" style="width: 100%;" readonly)
      el-form-item(label="出院日期" prop="dischargeDate" v-bind:label-width="labelWidth")
        el-date-picker(v-model="formModel.dischargeDate" type="date" placeholder="选择日期" value-format="yyyy-MM-dd" style="width: 100%;" readonly)
      ...
      el-form-item(label="重患时间" prop="heavyTime" v-bind:label-width="labelWidth")
        el-date-picker(v-model="formModel.heavyTime" type="date" placeholder="选择日期" value-format="yyyy-MM-dd" style="width: 100%;" readonly)
      ...
      el-form-item.address(label="修改人员" prop="modifyStaff" v-bind:label-width="labelWidth")
