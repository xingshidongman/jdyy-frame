<template lang="pug">
  kalix-dialog.user-add(bizKey="jdyyQue" ref="kalixBizDialog" v-bind:formModel.sync="formModel" v-bind:targetURL="targetURL" v-bind:submitBefore='submitBefore')
  ...
  export default {
    ...
    methods: {
      init(dialogOption) {
        ...
        delete this.formModel.limit
        delete this.formModel.page
        delete this.formModel.jsonMap
        delete this.formModel.rowNumber
        delete this.formModel.imgName
        // Vue.delete(this.formModel, 'imgName')
        console.log('---------this.formModel4444444444444------------', this.formModel)
      ...
      //       this.axios.request({
      //         method: 'PUT',
      //         url: JdyypatientsURL + '/${' + this.formModel.id + '}',
      //         data: this.formModel
      //       }).then(res => {
