          ...
          div.con1-right
            ...
            el-form-item.toleft(label="部位")
              el-radio-group(v-model="formModel.position" readonly)
                el-radio(label="左" disabled)
                el-radio(label="右" disabled)
                ...
                div.con2-right
                  el-form-item.mini(label="长柄" )
                    el-select(v-model="formModel.longHandle" placeholder="请选择" disabled)
                      el-option(label="是" value="是")
                      el-option(label="否" value="否")
                  el-form-item.unit-width.toleft(label="长度"  v-if="formModel.longHandle==='是'" label-width="60px" disabled)
                    el-input(v-model="formModel.longness" readonly)
                      template(slot="append") mm
                  el-form-item.unit-width(label="直径"  v-if="formModel.longHandle==='是'" label-width="60px" disabled)
              ...
              td.long-td
                ...
                div(v-if="formModel.vitium==='有'")
                  ...
                  el-form-item.mini(label-width="0px")
                    el-input(v-model="formModel.length" readonly)
                      template(slot="append") mm
              ...
              td.long-td
                ...
                div(v-if="formModel.vitium2==='有'")
                  div.left-align
                    p 区域
                  el-form-item.mini(label-width="0px")
                    el-input(v-model="formModel.length2" readonly)
                      template(slot="append") mm
                  el-form-item.mini(label="x" label-width="30px")
              ...
              td.long-td
                ...
                div
                  ...
                  el-form-item.short.toleft-p(label="术后")
                    el-input.short(v-model="formModel.postoperationDay" readonly)
                    span.p-left 天
                div.flex
